...
public final class SimpleSpanCodec {
    ...
    @Override public SimpleSpan fromJson(JsonReader reader) throws IOException {
      ...
      while (reader.hasNext()) {
        ...
        if (nextName.equals("traceId")) {
          ...
          reader.beginObject();
          while (reader.hasNext()) builder.putTag(reader.nextName(), reader.nextString());
          reader.endObject();
  ...
  static final Buffer.Writer<SimpleSpan> SPAN_WRITER = new Buffer.Writer<SimpleSpan>() {
    @Override public int sizeInBytes(SimpleSpan value) {
      ...
      sizeInBytes += asciiSizeInBytes("{\"traceId\":\"") + 16;
    ...
    @Override public void write(SimpleSpan value, Buffer b) {
      ...
      if (value.parentId() != null) {
        b.writeAscii("\",\"parentId\":\"").writeLowerHex(value.parentId());
      }
      b.writeAscii("\",\"id\":\"").writeLowerHex(value.id());
      if (value.kind() != null) {
        b.writeAscii("\",\"kind\":\"").writeJsonEscaped(value.kind().toString());
      }
